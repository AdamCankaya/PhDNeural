#!/usr/bin/env python3
"""Embed parsed master plan into phd_epi-decon_timeline_dashboard.html."""
...
STORAGE_KEY = "epi-decon_plan_progress_v1"


def main() -> int:
    plan_path = ROOT / "phd_epi-decon_master_plan.md"
    dashboard_path = ROOT / "phd_epi-decon_timeline_dashboard.html"
